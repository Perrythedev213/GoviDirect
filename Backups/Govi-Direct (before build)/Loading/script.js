...
console.log('GoviDirect loading script started');
...
async function preloadApp() {
  ...
  console.log(
    `Found ${assets.length} assets to preload`
  );
    ...
    await Promise.race([
      ...
      new Promise(resolve => {
        ...
        setTimeout(() => {
          ...
          console.warn(
            'Preload timeout reached. Continuing.'
          );
