...
(function() {
  ...
  function initCartPage() {
     ...
     * IMPORTANT:
     *
     * If this isn't the Cart page, do nothing.
     */
    ...
    /*
     * requestAnimationFrame is important here.
     *
     * The router has just replaced #app-content.
     * Waiting one frame guarantees the new Cart DOM
     * is fully available before rendering.
     */
  ...
  document.addEventListener(
    ...
    () => {
       ...
       * The router has just replaced #app-content.
       *
       * Wait until the browser has committed the
       * new DOM before checking for Cart.
       */
  ...
  window.addEventListener(
    ...
    event => {
      ...
      /*
       * Only render if the Cart DOM currently exists.
       *
       * This prevents an old Cart renderer from trying
       * to manipulate a different SPA page.
       */
