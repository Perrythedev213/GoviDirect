...
function initializeRouter() {
  ...
  async function animatePageOut(
     ...
     * visible state before applying the
     * transition class.
     */
  ...
  function animatePageIn(
    ...
    /*
     * Two animation frames ensure that the
     * browser paints the new page while it
     * is hidden before revealing it.
     */
  ...
  async function navigateTo(
    ...
    /*
     * Prevent two navigations from trying to
     * replace #app-content at the same time.
     */
    ...
    /*
     * Normal clicks to the current page should
     * do nothing.
     *
     * popstate is allowed to force loading because
     * the browser has already changed the URL before
    ...
    /* ===================================================
       FALLBACK IF NO SPA CONTAINER EXISTS
    =================================================== */
    ...
    try {
      ...
      /*
       * If another navigation somehow started
       * while we were waiting, stop this one.
       */
      ...
      /* =================================================
         CLEAR PAGE INITIALIZATION FLAGS
      ================================================= */
      ...
      /*
       * Make sure the page isn't left invisible
       * before falling back to a real navigation.
       */
  ...
  document.addEventListener(
    ...
    async event => {
       ...
       * IMPORTANT:
       *
       * Cart is intentionally NOT excluded anymore.
       *
       * Cart can therefore participate in the
  ...
  window.addEventListener(
    ...
    async () => {
       ...
       * IMPORTANT:
       *
       * When Back/Forward is pressed, the browser
       * changes window.location BEFORE firing popstate.
       *
       * Therefore navigateTo() must be forced to
       * reload the content even though targetUrl and
       * window.location.href now point to the same URL.
       */
